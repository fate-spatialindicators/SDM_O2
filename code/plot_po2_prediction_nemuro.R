...
saveRDS(mi_model,"output/wc/po2_model_nemuro.rds")
#####
...
saveRDS(pred_mi, file = "output/wc/pred_po2_nemuro.rds")
}

if(!fit_new_model) load("output/wc_po2_nemuro.Rdata")
...
# * 1000 b/c we are in UTM km for model fitting:
  ...
  ggsave(filename = "plots/po2map_nemuro.png", height = 9, width = 6.5, units = "in")
