...
saveRDS(mi_model,"output/wc/temp_model_nemuro.rds")
#####
...
saveRDS(pred_mi, file = "output/wc/pred_temp_nemuro.rds")
}

if(!fit_new_model) load("output/wc_temp_nemuro.Rdata")
...
# * 1000 b/c we are in UTM km for model fitting:
  ...
  ggsave(filename = "plots/tempmap_nemuro.png", height = 9, width = 6.5, units = "in")
